# Generated by Django 3.2 on 2023-02-12 22:10
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='prodct_image', to='products.product', verbose_name='Product')),
            ],
        ),
        migrations.AddField(
            model_name='brand',
